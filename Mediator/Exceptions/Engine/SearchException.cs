...
namespace CodeAnalyzer.Mediator.Exceptions.Engine
{
  ...
  [Serializable()]
  public class SearchException : BaseException
  {
    #region Construction .......................................................
    ...
    public SearchException(string msg, Exception innerException) : base(msg, innerException) { }

    public SearchException(object src, int code, string msg) : base(src, code, msg) { }

    public SearchException(object src, int code, string msg, Exception innerException) : base(src, code, msg, innerException) { }
