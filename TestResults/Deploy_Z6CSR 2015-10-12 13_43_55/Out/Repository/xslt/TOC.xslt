...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="Toc/TotalCategories">
      ...
      <tr >
        ...
        <td style="background:#E6EAE9;">
          <div style="padding-right:3px;">
            <a href="index.html" onClick="parent.location.reload(true);  parent.mainFrame.location.reload(true)">Home</a>
          </div>
        </td>
      </tr>
    </table>
                  ...
                  <div class="noteelement">
                    ...
                    <table class="" align="center" border="0" width="100%" cellpadding="0" cellspacing="0" summary="">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="float Text">
                            <a target="rulesFrame"><xsl:attribute name="href"><xsl:value-of select="Filename" disable-output-escaping="yes" /></xsl:attribute>Rules...</a>
                          </div>
                        </td>
                      </tr>
